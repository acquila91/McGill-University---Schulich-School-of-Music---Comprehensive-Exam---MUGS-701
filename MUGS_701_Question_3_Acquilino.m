...
filename = 'C:\Users\Camillo Acquilino\Desktop\McGill HP\Comp exam\Q3\Matlab\sounds\Good1.wav';
...
% stem(Index_attack_results, Results_TT, ':diamondr')
% Figure options
...
legend('Proposed method', 'Timbre Toolbox')
box on;
